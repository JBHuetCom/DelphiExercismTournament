...
uses System.SysUtils, uTournament;
...
begin
        CompareArrays
          ...
          TTournament.Tally(['Allegoric Alaskans;Blithering Badgers;loss',
          'Allegoric Alaskans;Blithering Badgers;win']));
end;
...
begin
        ...
        for i := Low(Array1) to High(Array1) do
                Assert.AreEqual(Array1[i], Array2[i],
                  format('Expecting element %d to = %s, Actual = %s',
                  [i, Array1[i], Array2[i]]));
end;
...
begin
        CompareArrays(TTournament.Tally([]),
          ['Team                           | MP |  W |  D |  L |  P']);
end;
...
begin
        CompareArrays
          ...
          TTournament.Tally(['Courageous Californians;Devastating Donkeys;win',
          'Allegoric Alaskans;Blithering Badgers;win',
          'Devastating Donkeys;Allegoric Alaskans;loss',
